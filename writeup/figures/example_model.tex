\begin{tikzpicture}[scale=1, transform shape]
  \begin{scope}[shift={(-0.4,0.0)}, rotate=45]
    ...
    \draw[<->] (-0.6,0.0) -- node[below,midway,rotate=-45] {$1$} (-0.6, 2.0);
    \draw[<->] (0.0,2.0) -- node[above left,midway,rotate=-45] {$0.1$} (0.4,2.0);
  ...
  \begin{scope}[shift={(0.4,0.0)}, rotate=-45]
    ...
    \draw[<->] (0.6,0.0) -- node[below,midway,rotate=45] {$1$} (0.6, 2.0);
    \draw[<->] (-0.0,2.0) -- node[above right,midway,rotate=45] {$0.1$} (-0.4,2.0);
